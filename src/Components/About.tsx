...
function About() {
  const [flipped, setFlipped] = useState([false, false, false, false, false]); // Added one more state for mini-card
  ...
  const cards = [
    ...
    },
    {
      ...
      back: [
        ...
        "<strong><u>Good news:</u></strong> I officially became a <span class='sound-trigger' onclick='handleSoundPlay'><strong><u>Software Developer</u></strong></span>!",
      ]
    },
    {
    ...
    },
    {
      ...
      back: [
        "<strong><span class='lesson-2'>Present:</span></strong> Have you noticed what do my hobbies have in common? Creation and problem solving. Yes, this is what drives me as a Developer.",
        ...
        "<strong><span class='lesson-2'>Lesson 1:</strong> <span class='lesson-1'>Life is unpredictable. Embrace change.",
        "<strong><span class='lesson-2'>Lesson 2:</strong> <span class='lesson-1'>The best gamble you can do, is against yourself.</span>",
        "<strong><span class='lesson-2'>Lesson 3:</strong> <span class='lesson-1'>We can only make descisions with the information we have at that time... But you can always adjust later.</span>",
        "<strong><span class='lesson-2'>Lesson 4:</strong> <span class='lesson-1'>When life gives you lemons... first check if <span class='lesson-2'> <i>lemons != null.</i></span>",
      ]
    },
  ];
